...
public class maindashboard extends JFrame implements ActionListener  {
    ...
    maindashboard() {
        ...
        JLabel l4 = new JLabel("Control Center");
        l4.setBounds(60, 20, 300, 60);
        ...
        b3 = new JButton("Customer Signup");
        b3.setBounds(0, 200, 270, 70);
        b3.setForeground(Color.WHITE);
        b3.setBackground(Color.blue);
        b3.setFont(new Font("Tohoma", Font.BOLD, 23));
        b3.setMargin(new Insets(0, 0, 0, 5));
        b3.addActionListener(this);
        p2.add(b3);

        b4 = new JButton("About Software");
        ...
        b5.setMargin(new Insets(0, 0, 0, 29));
        p2.add(b5);

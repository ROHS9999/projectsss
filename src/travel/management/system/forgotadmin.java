...
public class forgotadmin extends JFrame implements ActionListener {
    ...
    public forgotadmin() {
        ...
        Image i2 = i1.getImage().getScaledInstance(250, 250, SCALE_DEFAULT);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b1) {
            try {
                String sql = "select * from adminaccount where username = '" + t1.getText() + "'";
            ...
            try {
                String sql = "select * from adminaccount where answer = '" + t4.getText() + "' AND username = '" + t1.getText() + "' ";
                ResultSet rs = c.s.executeQuery(sql);
